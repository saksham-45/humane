...
The play cut is a critically damped spring on press (`src/client/cut.ts`, `src/client/spring.ts`). Do not replace it with a CSS fade except under `prefers-reduced-motion`.
