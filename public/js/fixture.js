const FIXTURE_PAIRS = [
    {
        ...
        topic: "bread",
        humanSide: "left",
        left: "The loaf cracked along the ear before I cut it. Steam still lived in the crumb. I tore a heel, salted it with my fingers, and ate standing at the board while the knife cooled.",
        right: "Bread is a staple food enjoyed across cultures. Freshly baked loaves offer a delightful aroma and a satisfying texture, presenting both challenges and opportunities for the home baker seeking consistent results.",
    ...
    },
    {
        ...
        topic: "rain",
        humanSide: "right",
        left: "Rainfall plays a vital role in ecosystems worldwide. Understanding precipitation patterns helps communities plan, adapt, and appreciate the interconnected nature of weather and daily life.",
        right: "It hit the tin first, then the alley. I counted eight breaths under the awning before the gutter found its voice. My socks were already lost.",
    ...
    },
    {
        ...
        topic: "letters",
        humanSide: "left",
        left: "I keep the unsent ones in a biscuit tin. The paper smells like the drawer. When I open it the folds remember my hands better than I do.",
        right: "Letter writing remains a meaningful form of communication. Taking time to compose thoughtful messages can strengthen relationships and preserve memories for future generations.",
    ...
    },
    {
        ...
        topic: "tools",
        humanSide: "right",
        left: "A well-organized toolkit enables efficient work. Selecting the right instrument for each task is a key principle of craftsmanship and professional practice.",
        right: "The rasp still had yesterday's oak in its teeth. I knocked it on the bench twice, then once more because two felt unfinished.",
    ...
    },
    {
        ...
        topic: "travel",
        humanSide: "left",
        left: "The ferry horn found us before the dock did. Someone's orange peeled in the wind and the peel stuck to my coat the whole crossing.",
        right: "Travel broadens perspective by exposing us to new environments. Ferries remain a practical and scenic option, combining convenience with an opportunity to reflect on the journey.",
...
let played = new Set(initial.played);
...
export function fixtureGuess(pairId, side) {
