...
export function stepSpring(state, target, dt, omega = 11) {
...
function settled(state, target) {
    return Math.abs(state.x - target) < 0.004 && Math.abs(state.v) < 0.02;
}
export function animateSpring(from, to, apply, omega = 11) {
